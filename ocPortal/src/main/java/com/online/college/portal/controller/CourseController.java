...
public class CourseController {
	...
	public ModelAndView learn(@PathVariable Long courseId){
		...
		AuthUser recomdCourseList=this.authUserService.getById(SessionContext.getUserId());
		//AuthUser recomdCourseList=this.authUserService.queryrecommd1(courseId);
		//List<AuthUser> recomdCourseList=new ArrayList();
		//recomdCourseList.add(recomdCourseList1);
		
		System.out.println("hsdaifhkasjdbfakjsbndkjdnbksajn"+recomdCourseList.getCourse1().toString());
